...
const singleLineBinding = {
  selector: ':matches(VariableDeclaration, ExportNamedDeclaration[declaration.type="VariableDeclaration"])',
  lineMode: "singleline" as const,
};
...
const paddingRule = createPaddingLineRule([
  ...
  {
    blankLine: "any",
    prev: singleLineBinding,
    next: singleLineBinding,
  },
  {
    blankLine: "any",
    prev: {
